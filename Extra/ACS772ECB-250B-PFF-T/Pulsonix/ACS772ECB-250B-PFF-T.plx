...
//15556622/1627512/2.50/35/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS772ECB-250B-PFF-T" (originalName "ACS772ECB-250B-PFF-T")
	...
	(compDef "ACS772ECB-250B-PFF-T" (originalName "ACS772ECB-250B-PFF-T") (compHeader (numPins 35) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS772ECB-250B-PFF-T"))
		...
		(attr "Mouser Part Number" "250-CS772ECB250BPFFT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS772ECB-250B-PFF-T?qs=vvQtp7zwQdP8xltXzDATeA%3D%3D")
		(attr "Manufacturer_Name" "Allegro Microsystems")
		(attr "Manufacturer_Part_Number" "ACS772ECB-250B-PFF-T")
		...
		(attr "<Hyperlink>" "https://www.allegromicro.com/en/products/sense/current-sensor-ics/fifty-to-two-hundred-amp-integrated-conductor-sensor-ics/acs772")
		(attr "<Component Height>" "7.1")
		(attr "<STEP Filename>" "ACS772ECB-250B-PFF-T.stp")
